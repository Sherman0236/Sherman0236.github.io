...
The [XorValue class](https://github.com/Sherman0236/XorData/blob/main/XorValue.hpp) is designed to encrypt/decrypt variable values (including pointers) at runtime.
...
1. Initially, the data is transformed into a 128-bit SIMD integer using the [Encode function](https://github.com/Sherman0236/XorData/blob/main/XorValue.hpp#L97). 
...
2. The decrypted data is now transformed from a 128-bit SIMD integer back to a 64-bit integer, pointer, float, or double using the [Decode](https://github.com/Sherman0236/XorData/blob/main/XorValue.hpp#L125) function.
